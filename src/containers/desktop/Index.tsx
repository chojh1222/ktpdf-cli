  ...
  public render(): JSX.Element {
    ...
    return (
      <div>
        ...
        <p><a href={`${url}:${port_node}/document/index.html?docNo=20190401000000001&regId=signer1`}>포탈 호출 생성자 페이지_new</a></p>
        ...
        <p><a href={'/contract/index.html?docNo=20190401000000001&signerNo=1'}>서명자 페이지</a></p>
